...
to layout
  layout-spring nodes links 0.5 150 1
end
...
;    ask location [ print link-with new-location ]
    

;    ask [ link-with a ] of location [ set thickness 0.5 ]

    ;ask [ link-with location ] of self [ set thickness 0.5 ]
    ...
    ask new-location
    [
      let thisNewLocation self
      if any? walkers in-radius 5 with [ who = thisWho ] 
      [
        ask thisWalker
        [
          setxy [xcor] of thisNewLocation [ycor] of thisNewLocation
          set heading thisHeading
          set location thisNewLocation
          set new-location nobody
        ]
      ]
    ]    
    ...
    ; jestlize se natoceni zmenilo po kroku
